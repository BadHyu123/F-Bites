...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Nguyễn Văn A', email: 'khachhang@test.com', role: 'BUYER' },
  { id: 'u2', name: 'Tiệm Bánh Cô Ba', email: 'coba@test.com', role: 'SELLER', shopName: 'Tiệm Bánh Cô Ba', isApproved: true, avatar: 'https://images.unsplash.com/photo-1556910103-1c02745a30bf?auto=format&fit=crop&w=200&q=80', shopAddress: '42 Nguyễn Huệ, Quận 1' },
  { id: 'u3', name: 'Admin Quản Trị', email: 'admin@test.com', role: 'ADMIN' },
  { id: 'u4', name: 'Cơm Tấm Sài Gòn', email: 'comtam@test.com', role: 'SELLER', shopName: 'Cơm Tấm Sài Gòn', isApproved: true },
  { id: 'u5', name: 'Phở Gia Truyền', email: 'pho@test.com', role: 'SELLER', shopName: 'Phở Gia Truyền', isApproved: true },
];

// Coordinates centered around Nguyen Hue, District 1, HCMC (approx 10.774, 106.703)
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    expiryTime: new Date(Date.now() + 3600 * 1000 * 3).toISOString(), // Expires in 3 hours
    quantity: 5,
    category: 'Bánh ngọt',
    rating: 4.8,
...
export const MOCK_ORDERS: Order[] = [
  ...
  // 3. Processing (Delivery - Waiting for Shipper)
  {
    id: 'DH-99214',
    buyerId: 'u1',
    sellerId: 'u2',
...
// Mock Data for Vietnam Administrative Units (Simplified)
