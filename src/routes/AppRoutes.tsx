...
export const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/admin/accounts" element={<ProtectedRoute allowedRole="ADMIN"><MainLayout><AccountManagement /></MainLayout></ProtectedRoute>} />
      <Route path="/admin/reports" element={<ProtectedRoute allowedRole="ADMIN"><MainLayout><AdminReports /></MainLayout></ProtectedRoute>} />
      <Route path="/admin/orders" element={<ProtectedRoute allowedRole="ADMIN"><MainLayout><AdminOrderManagement /></MainLayout></ProtectedRoute>} />
